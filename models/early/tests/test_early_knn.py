...
# === Setup for early model directory ===
...
# ✅ Import path config for early model
...
# --- Evaluation metrics ---
print("📊 Evaluation Metrics (Early KNN Model):")
...
if proba_available and len(np.unique(y_test)) == 2:
    ...
    plt.title('Receiver Operating Characteristic - Early KNN Model')
