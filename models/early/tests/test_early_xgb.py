...
y_test = pd.read_csv(Y_TEST_PATH).iloc[:, 0]  # Ensure 1D array
...
# === Evaluation ===
print("📊 Evaluation Metrics (Early XGBoost Model):")
...
if proba_available and len(np.unique(y_test)) == 2:
    ...
    plt.title('Receiver Operating Characteristic - Early XGBoost Model')
