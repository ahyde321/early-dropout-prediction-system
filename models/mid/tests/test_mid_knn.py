...
# File paths for KNN mid model evaluation
MODEL_PATH = os.path.join(BASE_DIR, "artifacts", "knn_model.pkl")
...
# --- Evaluation metrics ---
print("📊 Evaluation Metrics (KNN Mid Model):")
...
if proba_available and len(np.unique(y_test)) == 2:
    ...
    plt.title('Receiver Operating Characteristic (KNN Mid)')
