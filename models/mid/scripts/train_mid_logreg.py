...
print("🚀 Training Logistic Regression model (mid) with hyperparameter optimization...")
...
print("🎯 Mid Logistic Regression Model Training & Evaluation Completed Successfully!")