...
# Generate 5 records likely to graduate
for _ in range(5):
    low_risk_data.append({
        ...
        'Course': random.randint(1, 100),
        'Daytime/evening attendance': random.choice([0, 1]),
        'Previous qualification': random.randint(6, 10),  # Higher qualification level
        'Nationality': random.randint(1, 20),
        "Mother's qualification": random.randint(6, 10),  # Higher parental education
        "Father's qualification": random.randint(6, 10),
        "Mother's occupation": random.randint(6, 10),
        "Father's occupation": random.randint(6, 10),
        'Displaced': 0,  # Less likely to be displaced
        ...
        'Age at enrollment': random.randint(18, 25),
        'International': random.choice([0, 1]),
        'Curricular units 1st sem (credited)': random.randint(4, 6),
        'Curricular units 1st sem (enrolled)': random.randint(4, 6),
        'Curricular units 1st sem (evaluations)': random.randint(4, 6),
        'Curricular units 1st sem (approved)': random.randint(4, 6),
        'Curricular units 1st sem (grade)': random.uniform(10, 20),  # Higher grades
        'Curricular units 1st sem (without evaluations)': 0,
        'Curricular units 2nd sem (credited)': random.randint(4, 6),
        'Curricular units 2nd sem (enrolled)': random.randint(4, 6),
        'Curricular units 2nd sem (evaluations)': random.randint(4, 6),
        'Curricular units 2nd sem (approved)': random.randint(4, 6),
        'Curricular units 2nd sem (grade)': random.uniform(10, 20),  # Higher grades
        'Curricular units 2nd sem (without evaluations)': 0,
        'Unemployment rate': random.uniform(5, 10),
        'Inflation rate': random.uniform(0, 2),
        'GDP': random.uniform(3, 5)  # Higher GDP regions
    })
